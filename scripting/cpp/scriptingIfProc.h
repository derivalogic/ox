#ifndef BABEDFBB_B173_4651_9E06_26957D2CA6EC
#define BABEDFBB_B173_4651_9E06_26957D2CA6EC
...
public:
    ...
    void visit(NodeIf &node)
    {
        ...
        if (myNestedIfLvl)
            copy(node.affectedVars.begin(), node.affectedVars.end(), inserter(myVarStack.top(), myVarStack.top().end()));
    }
...
#endif /* BABEDFBB_B173_4651_9E06_26957D2CA6EC */
