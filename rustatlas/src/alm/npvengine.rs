...
// pub struct NPVEngine<'a, T: Real> {
//     instruments: &'a mut [Instrument],
//     market_store: &'a MarketStore<T>,
//     chunk_size: usize,
// }

// impl<'a, T: Real> NPVEngine<'a, T> {
//     pub fn new(instruments: &'a mut [Instrument], market_store: &'a MarketStore<T>) -> Self {
//         NPVEngine {
//             instruments,
//             market_store,
//             chunk_size: 1000,
...
//     pub fn run(&mut self) -> Result<BTreeMap<Date, T>> {
//         // indexing
