...
impl<T: Real + Send + Sync + 'static> AdvanceTermStructureInTime<T> for CompositeTermStructure<T> {
...
impl<T: Real + Send + Sync + 'static> YieldTermStructureTrait<T> for CompositeTermStructure<T> {}
