...
// struct ParValue<'a, T, R: Real> {
//     eval: &'a T,
//     npv_visitor: Box<NPVConstVisitor<'a, R>>,
//     fixing_visitor: Box<FixingVisitor<'a, R>>,
// }

// impl<'a, T, R: Real> ParValue<'a, T, R> {
//     pub fn new(eval: &'a T, market_data: &'a [MarketData<R>]) -> Self {
...
// impl<'a, R: Real> CostFunction for ParValue<'a, FixedRateInstrument, R> {
//     type Param = f64;
//     type Output = f64;
...
// impl<'a, R: Real> CostFunction for ParValue<'a, FloatingRateInstrument, R> {
//     type Param = f64;
//     type Output = f64;
//     fn cost(&self, param: &Self::Param) -> std::result::Result<Self::Output, Error> {
