...
//     utils::{errors::AtlasError, num::Real},
// };
...
// pub struct CashflowCompressorConstVisitor<T: Real> {
//     disbursements: RefCell<HashMap<SimpleCashlowGroup, Cashflow<T>>>,
//     redemptions: RefCell<HashMap<SimpleCashlowGroup, Cashflow<T>>>,
//     fixed_rate_coupons: RefCell<HashMap<FixedRateCashflowGroup, Cashflow<T>>>,
//     floating_rate_coupons: RefCell<HashMap<FloatingRateCashflowGroup, Cashflow<T>>>,
...
// impl<T: Real> CashflowCompressorConstVisitor<T> {
